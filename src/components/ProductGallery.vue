<template>
    <section id="galerie" class="py-20 px-4">
      <div class="max-w-7xl mx-auto">
        ...
        <p class="text-center text-xl text-gray-600 mb-16">
          Jedes Stück ein Unikat – klicke auf ein Produkt für mehr Details.
        </p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div
            ...
            :key="product.id"
            class="card bg-white shadow-2xl flex flex-col cursor-pointer transform hover:scale-105 transition-transform duration-300"
          ...
          >
            ...
            <div class="card-body flex-grow flex flex-col justify-between">
              <div>
                ...
                <p class="text-3xl font-bold text-funky-pink mt-4">{{ product.price }}€</p>
              </div>
            </div>
          </div>
        </div>
  ...
  <style scoped>
  .text-gradient {
    background-image: linear-gradient(to right, #FF1B8D, #9D4EDD);
